...
% For adding a horizontal line in the LOF, LOT, TOC (taken from: http://tex.stackexchange.com/questions/283070/insert-two-horizontal-lines-above-and-below-contents-and-list-of-figures)
...
% Package to customize TOC and LOF LOT. This package is not compatible with titletoc
%\usepackage{tocloft}
...
\usepackage[colorlinks=true,linktoc=all,backref=section,bookmarks=true]{hyperref}
...
% To display figures, tables and equations per section
\usepackage{chngcntr} 
\counterwithin{figure}{section}
\counterwithin{table}{section}
\counterwithin{equation}{section}

% Reference: https://www.physicsforums.com/threads/latex-list-of-figures-organised-by-chapter.290236/
...
% Add a rule after TOC for package tocloft
\renewcommand\cftaftertoctitle{\par\par\noindent\color{DarkBlue}{\hrulefill}\par\vskip 10pt}
\renewcommand\cftafterloftitle{\par\par\noindent\color{DarkBlue}{\hrulefill}\par\vskip 10pt}
\renewcommand\cftafterlottitle{\par\par\noindent\color{DarkBlue}{\hrulefill}\par\vskip 10pt}
...
%{\color{DarkBlue}\normalfont\Large\bfseries}
%{\color{DarkBlue}\thesubsubsectioin}{1em}{}
\titleformat{\paragraph}
{\color{DarkBlue}\normalfont\Large\bfseries}
{\color{DarkBlue}\theparagraph}{1em}{}
=======
% Customization of TOC/LOF/LOT with titletoc (taken from: http://tex.stackexchange.com/questions/60924/how-can-i-customize-the-list-of-tables-with-the-titletoc-package) and from: http://tex.stackexchange.com/questions/261364/modifying-list-of-tables-images
...
{\vspace{.4\baselineskip}\bfseries}
{\textcolor{DarkBlue}{\thecontentslabel\hspace{1.8mm}}}
{}
%{\titlerule\vspace*{.9\baselineskip}\raggedright\spacedallcaps}[\normalsize\vspace*{.8\baselineskip}\titlerule]
{\hspace{.5em}\titlerule*[10pt]{$\cdot$}\contentspage}
%{\titlerule\vspace*{.9\baselineskip}\raggedright[\normalsize\vspace*{.8\baselineskip}\titlerule]{$\cdot$}\contentspage}
...
\renewcommand*{\backref}[1]{\textbf{\textcolor{cornellred}{[#1]}}}
...
% Code to add an extra level (paragraph, taken from: )
\titleformat{\paragraph}
...
% Redefinition of the textcolor (taken from: http://tex.stackexchange.com/questions/21598/how-to-color-math-symbols)
%\makeatletter
...
% Tries to change colors of links (taken from: http://tex.stackexchange.com/questions/246386/changing-color-of-cites-with-hypersetup-not-working)
\AtBeginDocument{%
	\hypersetup{
		filecolor=cyan,
		linkcolor=DarkBlue,
