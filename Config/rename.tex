...
\renewcommand{\contentsname}{\textcolor{DarkBlue}{ÍNDICE DE LA TESIS}}
\renewcommand{\partname}{Parte}
\renewcommand{\appendixname}{\textcolor{DarkBlue}{APÉNDICES}}
\renewcommand{\figurename}{Figura}
\renewcommand{\listtablename}{\textcolor{DarkBlue}{ÍNDICE DE TABLAS}}
\renewcommand\listfigurename{\textcolor{DarkBlue}{ÍNDICE DE FIGURAS}}
\renewcommand{\chaptername}{Capítulo}
\renewcommand{\bibname}{Referencias}
\renewcommand\citeform[1]{(#1)}			% Changes reference format to [(1),(2),(3)]
\renewcommand{\nomname}{\textcolor{DarkBlue}{LISTA DE SÍMBOLOS}}
...
\renewcommand{\@cite}[1]{\textbf{\textcolor{cyan}{\cite{{#1}}}}}
\renewcommand\citeform[1]{\textcolor{indigo(dye)}{\textbf{[#1]}}}
