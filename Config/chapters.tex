...
% Change colors in math equations inside text (with $$)
\everymath{\color{NavyBlue}}

% Change colors for inline equations (with \begin{equation}
\everydisplay{\color{NavyBlue}}